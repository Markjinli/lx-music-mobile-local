...
export default memo(() => {
  ...
  const t = useI18n()
  const openHomePage = () => {
    void openUrl('https://github.com/Markjinli/lx-music-mobile-local#readme')
  }
  const openIssuePage = () => {
    void openUrl('https://github.com/Markjinli/lx-music-mobile-local/issues?q=is%3Aissue+')
  }
  const openGHReleasePage = () => {
    void openUrl('https://github.com/Markjinli/lx-music-mobile-local/releases')
  }
  const openFAQPage = () => {
    ...
    <Section title={t('setting_about')}>
      <View style={styles.part}>
        ...
        <TouchableOpacity onPress={openHomePage}>
          <Text style={textLinkStyle}>https://github.com/Markjinli/lx-music-mobile-local</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.part}>
